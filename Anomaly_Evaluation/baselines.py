...
#sys.path.append('/content/drive/MyDrive/road-anomaly-benchmark-master/methods/image_dissimilarity')
#sys.path.append('/content/drive/MyDrive/road-anomaly-benchmark-master/methods/image_segmentation')
#sys.path.append('/content/drive/MyDrive/road-anomaly-benchmark-master/methods/options')
#sys.path.append('/content/drive/MyDrive/road-anomaly-benchmark-master/methods/options')
sys.path.insert(0, './')
...
class ODIN:
    def __init__(self, model, magnitude=0.0001, temperature=3.0):
